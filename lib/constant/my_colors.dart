...
class SolidColors {
  ...
  static const Color profileName = Color.fromARGB(255, 66, 4, 87);
  static const Color textTitleFavorite = Color.fromARGB(255, 66, 4, 87);
...
class GradiantColors {
  ...
  static const List<Color> bottomNavBg = [Color.fromARGB(0, 255, 255, 255),  Color.fromARGB(255, 255, 255, 255)];
